...
$PAGE->set_title("$course->shortname: " . get_string('my_badges', 'format_mooin1pager'));
$PAGE->set_heading($course->fullname);
$PAGE->set_other_editing_capability('moodle/course:manageactivities');
$PAGE->set_url('/course/format/mooin1pager/badges.php', array('id' => $course->id));
...
echo $OUTPUT->render_from_template('format_mooin1pager/local/content/subpages/badges', $data);
echo $OUTPUT->footer();