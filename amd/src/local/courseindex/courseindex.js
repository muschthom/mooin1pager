 ...
 *
 * @module     format_mooin1pager/local/courseindex/courseindex
 * @class     format_mooin1pager/local/courseindex/courseindex
...
export default class Component extends BaseComponent {
    ...
    async _createSection({ state, element }) {
        ...
        // Create the new content.
        const newcomponent = await this.renderComponent(fakeelement, 'format_mooin1pager/local/courseindex/section', data);
        // Replace the fake node with the real content.
        const newelement = newcomponent.getElement();
