...
$PAGE->set_title("$course->shortname: " . get_string('forums', 'format_mooin1pager'));
$PAGE->set_heading($course->fullname);
$PAGE->set_other_editing_capability('moodle/course:manageactivities');
$PAGE->set_url('/course/format/mooin1pager/all_discussionforums.php', array('id' => $course->id));
...
echo $OUTPUT->render_from_template('format_mooin1pager/local/content/subpages/all_discussionforums', $data);
echo $OUTPUT->footer();
